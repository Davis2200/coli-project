...
export interface ColiNotification {
  id: string;
  title: string;
  message: string;
  time: string;
...
export const MOCK_NOTIFICATIONS: Record<string, ColiNotification[]> = {
  turista: [
    { id: "n1", title: "¡Reserva Confirmada!", message: "Tu mesa en Sabor a Maguey está lista para hoy a las 8 PM.", time: "2 min", type: "success", read: false },
    { id: "n2", title: "Nueva Promoción", message: "20% de descuento en Vuelo en Globo este fin de semana.", time: "1h", type: "promo", read: false },
    { id: "n3", title: "Pago Exitoso", message: "Hemos recibido tu anticipo para el Tour de Coyoacán.", time: "5h", type: "info", read: true },
  ],
  afiliado: [
    { id: "a1", title: "Comisión Recibida", message: "Has ganado $150 MXN por la reserva de David Explorador.", time: "10 min", type: "success", read: false },
    { id: "a2", title: "Campaña Activa", message: "Nuevas promociones de Hoteles disponibles para compartir.", time: "3h", type: "info", read: false },
    { id: "a3", title: "Recibo de Pago", message: "Tu transferencia mensual ha sido procesada con éxito.", time: "1d", type: "info", read: true },
  ],
  business: [
    { id: "b1", title: "Nueva Reserva", message: "Un grupo de 4 personas ha reservado para mañana a las 2 PM.", time: "5 min", type: "alert", read: false },
    { id: "b2", title: "Pago Completado", message: "Se han liberado $2,400 MXN de una reserva validada.", time: "45 min", type: "success", read: false },
    { id: "b3", title: "Métrica Semanal", message: "Tu negocio ha recibido 1,200 visitas más que la semana pasada.", time: "6h", type: "info", read: true },
  ]
};
